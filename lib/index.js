...
function transform(opt) {
  ...
  var unitPrecision = opt.unitPrecision;
  var keepPix = opt.keepPix;
  ...
  return function (decl) {
    ...
    var count = Number(value.slice(0, -2));
    var revise = Number((count / root).toFixed(unitPrecision));
    var expected = { value: revise + 'rem' };
